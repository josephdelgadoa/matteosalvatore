                ...
                <div className="py-10 border-t border-ms-fog flex flex-col items-center justify-center gap-5">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        ...
                        <div className="w-[64px] h-[40px] bg-white border border-gray-200 shadow-[0_2px_4px_rgba(0,0,0,0.02)] rounded-[4px] flex items-center justify-center p-2 hover:shadow-md transition-shadow">
                            <img src="/images/payments/visa.svg" alt="Visa" className="w-[85%] h-auto object-contain" />
                        </div>
                        {/* Mastercard */}
                        <div className="w-[64px] h-[40px] bg-white border border-gray-200 shadow-[0_2px_4px_rgba(0,0,0,0.02)] rounded-[4px] flex items-center justify-center p-2 hover:shadow-md transition-shadow">
                            <img src="/images/payments/mastercard.svg" alt="Mastercard" className="w-[80%] h-auto object-contain" />
                        </div>
                        {/* American Express */}
                        <div className="w-[64px] h-[40px] bg-white border border-gray-200 shadow-[0_2px_4px_rgba(0,0,0,0.02)] rounded-[4px] flex items-center justify-center p-1.5 hover:shadow-md transition-shadow">
                            <img src="/images/payments/amex.svg" alt="American Express" className="w-[90%] h-auto object-contain" />
                        </div>
                        {/* Diners Club */}
                        <div className="w-[64px] h-[40px] bg-white border border-gray-200 shadow-[0_2px_4px_rgba(0,0,0,0.02)] rounded-[4px] flex items-center justify-center p-1.5 hover:shadow-md transition-shadow">
                            <img src="/images/payments/diners.svg" alt="Diners Club" className="w-[90%] h-auto object-contain" />
                        </div>
                        {/* Yape */}
                        <div className="w-[64px] h-[40px] bg-white border border-gray-200 shadow-[0_2px_4px_rgba(0,0,0,0.02)] rounded-[4px] flex items-center justify-center p-1.5 hover:shadow-md transition-shadow">
                           <img src="/images/payments/yape.svg" alt="Yape" className="w-[90%] h-auto object-contain" />
                        </div>
                    </div>
                </div>
