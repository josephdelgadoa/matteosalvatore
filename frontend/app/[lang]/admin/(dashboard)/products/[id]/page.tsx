                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1">
                            <Input
                                ...
                                placeholder="Auto-generated by AI but editable"
                            />
                            <p className="text-xs text-ms-brand-primary mt-1 font-medium">Auto-assigned based on product type recognition.</p>
                        </div>
                                ...
                                <ReactQuill
                                    ...
                                    onChange={value => {
                                        if (value !== formData.description_es) {
                                            setFormData(prev => ({ ...prev, description_es: value }));
                                        }
                                    }}
