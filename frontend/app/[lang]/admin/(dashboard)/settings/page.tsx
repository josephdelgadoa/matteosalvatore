            ...
            <div className="space-y-8">
                ...
                <section className="bg-ms-white p-6 border border-ms-fog space-y-6">
                    <div className="flex items-center justify-between border-b border-ms-fog pb-2 mb-4">
                        <h3 className="font-medium text-lg">Homepage Hero Slider</h3>
                    ...
                    {currentSlides.map((slide, index) => (
                        <div key={slide.id} className="border border-ms-fog p-4 rounded-md space-y-4">
                            <h4 className="font-medium text-ms-stone">Slide {index + 1} ({activeLang.toUpperCase()})</h4>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="ms-label block mb-2">Background Image</label>
                                    <ImageUploader
                                ...
                                <div className="space-y-4">
                                    ...
                                    />
                                    <div>
                                        <label className="ms-label block mb-1">Description</label>
                                        <textarea
