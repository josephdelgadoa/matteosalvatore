...
export default function ProductListingPage({ params }: { params: { lang: Locale } }) {
    ...
    return (
        <div>
            <PageHero
                ...
                image="/images/hero-image-ruso-2.jpeg"
            />

            <div className="ms-container py-12 md:py-20">
                <div className="mb-12 md:mb-16 text-center">
                    <p className="text-ms-stone max-w-lg mx-auto">Explore our complete collection of premium menswear, crafted for the modern gentleman.</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
                    {products.map((product) => {
                        ...
                        return (
                            <Link href={getLocalizedPath(`/products/${productSlug}`, params.lang)} key={product.id} className="group cursor-pointer">
