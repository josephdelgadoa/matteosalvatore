...
export default function CategoryPage({ params }: { params: { slug: string } }) {
    ...
    return (
        <div className="ms-container py-12 md:py-20 animate-fade-in">
            <div className="mb-12 md:mb-20 text-center">
                <span className="ms-label mb-2 block text-ms-stone">Collection</span>
                <h1 className="ms-heading-1 mb-4">{categoryTitle}</h1>
            ...
            {products.length === 0 ? (
                <div className="text-center py-20 bg-ms-stone/5 rounded-lg">
                    ...
                    <Link href="/products" className="text-ms-black underline mt-4 inline-block hover:opacity-70">
                        View All Products
                    </Link>
                </div>
            ) : (
